          ...
          <div className='desc'>
            ...
            <div>
              <ul className='mb-4'>
                <li className='mb-4'>
                  <div className='mb-1'>
                    <span className='label' style={style}>{item.p4_3}</span>
                    <Select className='mx-3 w-45' placeholder={item.ph1} >
                ...
                <li className='mb-4'>
                  <div className='mb-1'>
                    <span className='label' style={style}>{item.p4_4}</span>
                    <Select className='mx-3 w-45' placeholder={item.ph1} >
                      <Option value='jack'>Jack</Option>
                    </Select>
                  </div>
                ...
                <li className='mb-4'>
                  <div className='mb-1'>
                    <span className='label' style={style}>{item.p4_5}</span>
                    <Select className='mx-3 w-45' placeholder={item.ph1} >
                      <Option value='jack'>Jack</Option>
                    </Select>
                  </div>
