            ...
            <div className='row gx-5 mb-4'>
              ...
              <div className='col-6 mb-2'>
                <div className='row align-items-center'>
                  ...
                  <div className='col-9'>
                    <Select
                      className='currency-selector w-100'
                      placeholder={Item.ph11}
                      style={{ width: '186px' }}
                      dropdownAlign={{ offset: [1, 5] }}
                      dropdownClassName='currency-dropdown'
                    >
                      <Option value='جنية'>عادية</Option>
                      <Option value='ريال'>ممنازة</Option>
                    </Select>
                  </div>
                </div>
              </div>
