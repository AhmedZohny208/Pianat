...
export default function AppViews({ collapsed }) {
  return (
    <Suspense fallback={<Loading cover="content"/>}>
      <Switch>
        ...
        <Route path={`${APP_PREFIX_PATH}/mokhlfat/investment-funds-violations/Investment-policy-violations`} component={lazy(() => import(`./mokhalfat/investmentPolicyViolations`))} exact />
        ...
        <Route path={`${APP_PREFIX_PATH}/mokhlfat/service-provider-violations/violation`} component={lazy(() => import(`./mokhalfat/SingleServiceProviderViolation`))} exact />
