    ...
    >
      ...
      <div className='text-center'>
        <div className='row gx-0'>
          <div className='col-6'>
            <button
              className='btn newSub-btn'
              onClick={() =>
                history.push(
                  `${APP_PREFIX_PATH}/create-subscription/stock-fund`
                )
              }
            >
              {' '}
              <NewSubModal className='newSub-btn-svg' />
              صندوق اوراق مالية
            </button>
          </div>
          <div className='col-6'>
            <button className='btn newSub-btn'>
              {' '}
              <NewSubModal className='newSub-btn-svg' />
              صندوق قابض / صندوق صناديق
            </button>
          </div>
        </div>
        <div className='row gx-0'>
