  ...
  return (
    ...
    >
      ...
      <Form form={form} name='comment' layout='vertical'>
        <Form.Item label='البند تم التعليق' name='item'>
          <Select
            className='mx-0 mb-4'
            placeholder='اختر اسم البند المراد تعليق فيه'
        ...
        <Form.Item label='التعليقات' name='getHelpIn'>
          <TextArea autoSize={{ minRows: 4, maxRows: 5 }} />
        </Form.Item>

        <Form.Item className='solution-text' name='solution'>
          <TextArea placeholder='اكتب سبب تعليقك هنا' rows={4} />
        </Form.Item>
